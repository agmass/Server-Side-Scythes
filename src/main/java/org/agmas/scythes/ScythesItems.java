...
public class ScythesItems {
    ...
    public static final Item NETHERITE_SCYTHE = register(
            new Scythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(ToolMaterials.NETHERITE, 3.6f, -3.2f)), ToolMaterials.DIAMOND),
            "netherite_scythe"
    );
    ...
    public static final Item CLOUD_SCYTHE = register(
            new CloudScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(CloudMaterial.INSTANCE, 4f, -3.2f)), CloudMaterial.INSTANCE),
            "cloud_scythe"
    );
    public static final Item TURTLE_SCYTHE = register(
            new TurtleScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(TurtleMaterial.INSTANCE, 4f, -3.2f)), TurtleMaterial.INSTANCE),
            "turtle_scythe"
    );
    public static final Item GUNPOWDER_SCYTHE = register(
            new GunpowderScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(GunpowderMaterial.INSTANCE, 4f, -3.2f)), GunpowderMaterial.INSTANCE),
            "gunpowder_scythe"
    );
    public static final Item SUSPICIOUS_SCYTHE = register(
            new SuspicousScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(SuspiciousMaterial.INSTANCE, 4f, -3.2f)), SuspiciousMaterial.INSTANCE),
            "suspicious_scythe"
    );
    public static final Item GOLEM_SCYTHE = register(
            new GolemScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(GolemMaterial.INSTANCE, 4f, -3.5F)), GolemMaterial.INSTANCE),
            "golem_scythe"
    );
    public static final Item ICE_SCYTHE = register(
            new IceScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(IceMaterial.INSTANCE, 4f, -3.2F)), IceMaterial.INSTANCE),
            "ice_scythe"
    );
    public static final Item ENDER_SCYTHE = register(
            new EnderScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(EnderMaterial.INSTANCE, 4f, -3.2F)), EnderMaterial.INSTANCE),
            "ender_scythe"
    );
    public static final Item BORDER_SCYTHE = register(
            new BorderScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(ToolMaterials.DIAMOND, 4f, -3.2F)), ToolMaterials.DIAMOND),
            "border_scythe"
    );
        public static final Item BAN_SCYTHE = register(
            new BanScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(ToolMaterials.DIAMOND, 4f, -3.2F)), ToolMaterials.DIAMOND),
            "ban_scythe"
    );
    public static final Item GROWTH_SCYTHE = register(
            new GrowthScythe(new Item.Settings().attributeModifiers(Scythe.createAttributeModifiers(GrowthMaterial.INSTANCE, 4f, -3.2F)), GrowthMaterial.INSTANCE),
            "growth_scythe"
    );
